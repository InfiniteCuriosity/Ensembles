...
### Did the automated results using the Ensembles package beat the best results by the college students in their 699 Kaggle submissions by more than 90%? Let's test that out:
...
2b. How to reduce highly correlated predictors

2c. What if you have new data?
