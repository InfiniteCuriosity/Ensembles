...
head_df <- head(df, n = 10)
  ...
  for (i in 1:numresamples) {
    ...
    robust_validation_RMSE[i] <- Metrics::rmse(actual = validation$y, predicted = predict(
      object = MASS::rlm(y ~ ., data = train),
      newdata = validation
    ))
  ...
  #### LQS visualizations ####
  lqs_df <- data.frame(
    actual = c(test$y, validation$y), predicted = as.numeric(y_hat_lqs),
  ...
  robust_df <- data.frame(
    actual = c(test$y, validation$y), predicted = as.numeric(y_hat_robust),
  ...
  summary_results <- data.frame(
    ...
    "Overfitting_min" = round(c(
      ...
      boost_rf_overfitting_range[1], cubist_overfitting_range[1], min(elastic_overfitting_df$elastic_overfitting[2:nrow(elastic_overfitting_df)]), gam_overfitting_range[1], gb_overfitting_range[1],
      knn_overfitting_range[1], min(lasso_overfitting_df$lasso_overfitting[2:nrow(lasso_overfitting_df)]), linear_overfitting_range[1], lqs_overfitting_range[1], neuralnet_overfitting_range[1],
      ...
      robust_overfitting_range[1], rpart_overfitting_range[1], svm_overfitting_range[1], tree_overfitting_range[1], xgb_overfitting_range[1],
    ...
    "Overfitting_max" = round(c(
      ...
      boost_rf_overfitting_range[2], cubist_overfitting_range[2], min(elastic_overfitting_df$elastic_overfitting[2:nrow(elastic_overfitting_df)]), gam_overfitting_range[2], gb_overfitting_range[2],
      knn_overfitting_range[2], min(lasso_overfitting_df$lasso_overfitting[2:nrow(lasso_overfitting_df)]), linear_overfitting_range[2], lqs_overfitting_range[2], neuralnet_overfitting_range[2],
      ...
      robust_overfitting_range[2], rpart_overfitting_range[2], svm_overfitting_range[2], tree_overfitting_range[2], xgb_overfitting_range[2],
...
overfitting_data <-
    data.frame(
      ...
      "data" = c(
        ...
        cubist_overfitting, elastic_overfitting_df$elastic_overfitting[2:nrow(elastic_overfitting_df)], gam_overfitting,
        gb_overfitting, knn_overfitting, lasso_overfitting_df$lasso_overfitting[2:nrow(lasso_overfitting_df)], linear_overfitting,
        lqs_overfitting, neuralnet_overfitting, pcr_overfitting, pls_overfitting,
        rf_overfitting, ridge_overfitting_df$ridge_overfitting[2:nrow(ridge_overfitting_df)], robust_overfitting, rpart_overfitting,
        ...
        ensemble_boost_rf_overfitting, ensemble_cubist_overfitting,
...
accuracy_barchart <- ggplot2::ggplot(summary_results, aes(x = reorder(Model, Mean_holdout_RMSE), y = Mean_holdout_RMSE)) +
  ...
  ggplot2::ylim(0, max(summary_results$Mean_holdout_RMSE) + 2)
...
overfitting_barchart <- ggplot2::ggplot(summary_results, aes(x = reorder(Model, Overfitting_mean), y = Overfitting_mean)) +
  ...
  ggplot2::ylim(0, max(summary_results$Overfitting_mean) +2)
...
duration_barchart <- ggplot2::ggplot(summary_results, aes(x = reorder(Model, Duration), y = Duration)) +
  ...
  ggplot2::ylim(0, max(summary_results$Duration) + 2)
  ...
  total_data <-
    data.frame(
      ...
      "test" = c(
        bag_rf_test_RMSE, bagging_test_RMSE, bayesglm_test_RMSE,
      ...
      "validation" = c(
        bag_rf_validation_RMSE, bagging_validation_RMSE, bayesglm_validation_RMSE,
  ...
  total_plot <- ggplot2::ggplot(data = total_data, mapping = ggplot2::aes(x = count, y = data, color = model)) +
    ...
    ggplot2::scale_color_manual(
      ...
      values = c(
        "train" = "blueviolet", "test" = "darkcyan", "validation" = "darkgray", "holdout" = "turquoise1", "mean" = "black",
        "optimal" = "red"
      )
    )
  ...
  if (do_you_have_new_data == "Y") {
    ...
    str(df)
    return(list(
      "head_of_data" = head_df, "accuracy_plot" = accuracy_plot, "total_plot" = total_plot, "overfitting_plot" = overfitting_plot,
