...
adaboost_train_true_positive_rate <- 0
adaboost_train_true_negative_rate <- 0
adaboost_train_false_positive_rate <- 0
adaboost_train_false_negative_rate <- 0
adaboost_train_accuracy <- 0
adaboost_train_F1_score <- 0
adaboost_test_true_positive_rate <- 0
adaboost_test_true_negative_rate <- 0
adaboost_test_false_positive_rate <- 0
adaboost_test_false_negative_rate <- 0
adaboost_test_accuracy <- 0
adaboost_test_F1_score <- 0
adaboost_validation_true_positive_rate <- 0
adaboost_validation_true_negative_rate <- 0
adaboost_validation_false_positive_rate <- 0
adaboost_validation_false_negative_rate <- 0
adaboost_validation_accuracy <- 0
adaboost_validation_F1_score <- 0
adaboost_holdout_true_positive_rate <- 0
adaboost_holdout_true_negative_rate <- 0
adaboost_holdout_false_positive_rate <- 0
adaboost_holdout_false_negative_rate <- 0
adaboost_holdout_accuracy <- 0
adaboost_holdout_F1_score <- 0
adaboost_duration <- 0
adaboost_train_positive_predictive_value <- 0
adaboost_train_negative_predictive_value <- 0
adaboost_test_positive_predictive_value <- 0
adaboost_test_negative_predictive_value <- 0
adaboost_validation_positive_predictive_value <- 0
adaboost_validation_negative_predictive_value <- 0
adaboost_holdout_positive_predictive_value <- 0
adaboost_holdout_negative_predictive_value <- 0
...
pls_train_true_positive_rate <- 0
pls_train_true_negative_rate <- 0
pls_train_false_positive_rate <- 0
pls_train_false_negative_rate <- 0
pls_train_accuracy <- 0
pls_train_F1_score <- 0
pls_test_true_positive_rate <- 0
pls_test_true_negative_rate <- 0
pls_test_false_positive_rate <- 0
pls_test_false_negative_rate <- 0
pls_test_accuracy <- 0
pls_test_F1_score <- 0
pls_validation_true_positive_rate <- 0
pls_validation_true_negative_rate <- 0
pls_validation_false_positive_rate <- 0
pls_validation_false_negative_rate <- 0
pls_validation_accuracy <- 0
pls_validation_F1_score <- 0
pls_holdout_true_positive_rate <- 0
pls_holdout_true_negative_rate <- 0
pls_holdout_false_positive_rate <- 0
pls_holdout_false_negative_rate <- 0
pls_holdout_accuracy <- 0
pls_holdout_F1_score <- 0
pls_duration <- 0
pls_train_positive_predictive_value <- 0
pls_train_negative_predictive_value <- 0
pls_test_positive_predictive_value <- 0
pls_test_negative_predictive_value <- 0
pls_validation_positive_predictive_value <- 0
pls_validation_negative_predictive_value <- 0
pls_holdout_positive_predictive_value <- 0
pls_holdout_negative_predictive_value <- 0
...
rda_train_true_positive_rate <- 0
rda_train_true_negative_rate <- 0
rda_train_false_positive_rate <- 0
rda_train_false_negative_rate <- 0
rda_train_accuracy <- 0
rda_train_F1_score <- 0
rda_test_true_positive_rate <- 0
rda_test_true_negative_rate <- 0
rda_test_false_positive_rate <- 0
rda_test_false_negative_rate <- 0
rda_test_accuracy <- 0
rda_test_F1_score <- 0
rda_validation_true_positive_rate <- 0
rda_validation_true_negative_rate <- 0
rda_validation_false_positive_rate <- 0
rda_validation_false_negative_rate <- 0
rda_validation_accuracy <- 0
rda_validation_F1_score <- 0
rda_holdout_true_positive_rate <- 0
rda_holdout_true_negative_rate <- 0
rda_holdout_false_positive_rate <- 0
rda_holdout_false_negative_rate <- 0
rda_holdout_accuracy <- 0
rda_holdout_F1_score <- 0
rda_duration <- 0
rda_train_positive_predictive_value <- 0
rda_train_negative_predictive_value <- 0
rda_test_positive_predictive_value <- 0
rda_test_negative_predictive_value <- 0
rda_validation_positive_predictive_value <- 0
rda_validation_negative_predictive_value <- 0
rda_holdout_positive_predictive_value <- 0
rda_holdout_negative_predictive_value <- 0
...
ensemble_adaboost_train_true_positive_rate <- 0
ensemble_adaboost_train_true_negative_rate <- 0
ensemble_adaboost_train_false_positive_rate <- 0
ensemble_adaboost_train_false_negative_rate <- 0
ensemble_adaboost_train_accuracy <- 0
ensemble_adaboost_train_F1_score <- 0
ensemble_adaboost_test_true_positive_rate <- 0
ensemble_adaboost_test_true_negative_rate <- 0
ensemble_adaboost_test_false_positive_rate <- 0
ensemble_adaboost_test_false_negative_rate <- 0
ensemble_adaboost_test_accuracy <- 0
ensemble_adaboost_test_F1_score <- 0
ensemble_adaboost_validation_true_positive_rate <- 0
ensemble_adaboost_validation_true_negative_rate <- 0
ensemble_adaboost_validation_false_positive_rate <- 0
ensemble_adaboost_validation_false_negative_rate <- 0
ensemble_adaboost_validation_accuracy <- 0
ensemble_adaboost_validation_F1_score <- 0
ensemble_adaboost_holdout_true_positive_rate <- 0
ensemble_adaboost_holdout_true_negative_rate <- 0
ensemble_adaboost_holdout_false_positive_rate <- 0
ensemble_adaboost_holdout_false_negative_rate <- 0
ensemble_adaboost_holdout_accuracy <- 0
ensemble_adaboost_holdout_F1_score <- 0
ensemble_adaboost_duration <- 0
ensemble_adaboost_train_positive_predictive_value <- 0
ensemble_adaboost_train_negative_predictive_value <- 0
ensemble_adaboost_test_positive_predictive_value <- 0
ensemble_adaboost_test_negative_predictive_value <- 0
ensemble_adaboost_validation_positive_predictive_value <- 0
ensemble_adaboost_validation_negative_predictive_value <- 0
ensemble_adaboost_holdout_positive_predictive_value <- 0
ensemble_adaboost_holdout_negative_predictive_value <- 0
...
for (i in 1:numresamples) {
  ...
  adaboost_train_fit <- MachineShop::fit(formula = as.factor(y) ~ ., data = train01, model = "AdaBoostModel")

  adaboost_train_pred <- stats::predict(adaboost_train_fit, train01, type = "prob")
  ...
  adaboost_train_true_positive_rate[i] <- adaboost_train_table[2,2] / sum(adaboost_train_table[2, 2] + adaboost_train_table[1, 2])
  adaboost_train_true_positive_rate_mean <- mean(adaboost_train_true_positive_rate)
  adaboost_train_true_negative_rate[i] <- adaboost_train_table[1,1]/ sum(adaboost_train_table[1,1] + adaboost_train_table[2,1])
  adaboost_train_true_negative_rate_mean <- mean(adaboost_train_true_negative_rate)
  adaboost_train_false_positive_rate[i] <- adaboost_train_table[2, 1] / sum(adaboost_train_table[2, 1] + adaboost_train_table[1, 1])
  adaboost_train_false_positive_rate_mean <- mean(adaboost_train_false_positive_rate)
  adaboost_train_false_negative_rate[i] <- adaboost_train_table[1, 2] / sum(adaboost_train_table[1, 2] + adaboost_train_table[2, 2])
  adaboost_train_false_negative_rate_mean <- mean(adaboost_train_false_negative_rate)
  ...
  adaboost_train_F1_score[i] <- 2*(adaboost_train_table[2,2]) / sum(2 * adaboost_train_table[2,2] + adaboost_train_table[1,2] + adaboost_train_table[2,1])
  adaboost_train_F1_score_mean <- mean(adaboost_train_F1_score)
  adaboost_train_positive_predictive_value[i] = adaboost_train_table[2, 2] / sum(adaboost_train_table[2, 2] + adaboost_train_table[2, 1])
  adaboost_train_positive_predictive_value_mean <- mean(adaboost_train_positive_predictive_value)
  adaboost_train_negative_predictive_value[i] <- adaboost_train_table[1, 1]/ sum(adaboost_train_table[1, 1] + adaboost_train_table[1, 2])
  adaboost_train_negative_predictive_value_mean <- mean(adaboost_train_negative_predictive_value)

  adaboost_test_pred <- stats::predict(adaboost_train_fit, test01, type = "prob")
  adaboost_test_predictions <- ifelse(adaboost_test_pred > 0.5, 1, 0)
  adaboost_test_table <- table(adaboost_test_predictions, y_test)
  adaboost_test_true_positive_rate[i] <- adaboost_test_table[2,2] / sum(adaboost_test_table[2, 2] + adaboost_test_table[1, 2])
  adaboost_test_true_positive_rate_mean <- mean(adaboost_test_true_positive_rate)
  adaboost_test_true_negative_rate[i] <- adaboost_test_table[1,1]/ sum(adaboost_test_table[1,1] + adaboost_test_table[2,1])
  adaboost_test_true_negative_rate_mean <- mean(adaboost_test_true_negative_rate)
  adaboost_test_false_positive_rate[i] <- adaboost_test_table[2, 1] / sum(adaboost_test_table[2, 1] + adaboost_test_table[1, 1])
  adaboost_test_false_positive_rate_mean <- mean(adaboost_test_false_positive_rate)
  adaboost_test_false_negative_rate[i] <- adaboost_test_table[1, 2] / sum(adaboost_test_table[1, 2] + adaboost_test_table[2, 2])
  adaboost_test_false_negative_rate_mean <- mean(adaboost_test_false_negative_rate)
  ...
  adaboost_test_F1_score[i] <- 2*(adaboost_test_table[2,2]) / sum(2 * adaboost_test_table[2,2] + adaboost_test_table[1,2] + adaboost_test_table[2,1])
  adaboost_test_F1_score_mean <- mean(adaboost_test_F1_score)
  adaboost_test_positive_predictive_value[i] = adaboost_test_table[2, 2] / sum(adaboost_test_table[2, 2] + adaboost_test_table[2, 1])
  adaboost_test_positive_predictive_value_mean <- mean(adaboost_test_positive_predictive_value)
  adaboost_test_negative_predictive_value[i] <- adaboost_test_table[1, 1]/ sum(adaboost_test_table[1, 1] + adaboost_test_table[1, 2])
  adaboost_test_negative_predictive_value_mean <- mean(adaboost_test_negative_predictive_value)

  adaboost_validation_pred <- stats::predict(adaboost_train_fit, validation01, type = "prob")
  adaboost_validation_predictions <- ifelse(adaboost_validation_pred > 0.5, 1, 0)
  adaboost_validation_table <- table(adaboost_validation_predictions, y_validation)
  adaboost_validation_true_positive_rate[i] <- adaboost_validation_table[2,2] / sum(adaboost_validation_table[2, 2] + adaboost_validation_table[1, 2])
  adaboost_validation_true_positive_rate_mean <- mean(adaboost_validation_true_positive_rate)
  adaboost_validation_true_negative_rate[i] <- adaboost_validation_table[1,1]/ sum(adaboost_validation_table[1,1] + adaboost_validation_table[2,1])
  adaboost_validation_true_negative_rate_mean <- mean(adaboost_validation_true_negative_rate)
  adaboost_validation_false_positive_rate[i] <- adaboost_validation_table[2, 1] / sum(adaboost_validation_table[2, 1] + adaboost_validation_table[1, 1])
  adaboost_validation_false_positive_rate_mean <- mean(adaboost_validation_false_positive_rate)
  adaboost_validation_false_negative_rate[i] <- adaboost_validation_table[1, 2] / sum(adaboost_validation_table[1, 2] + adaboost_validation_table[2, 2])
  adaboost_validation_false_negative_rate_mean <- mean(adaboost_validation_false_negative_rate)
  adaboost_validation_accuracy[i] <- (adaboost_validation_table[1,1] + adaboost_validation_table[2,2]) / sum(adaboost_validation_table)
  adaboost_validation_accuracy_mean <- mean(adaboost_validation_accuracy)
  adaboost_validation_F1_score[i] <- 2*(adaboost_validation_table[2,2]) / sum(2 * adaboost_validation_table[2,2] + adaboost_validation_table[1,2] + adaboost_validation_table[2,1])
  adaboost_validation_F1_score_mean <- mean(adaboost_validation_F1_score)
  adaboost_validation_positive_predictive_value[i] = adaboost_validation_table[2, 2] / sum(adaboost_validation_table[2, 2] + adaboost_validation_table[2, 1])
  adaboost_validation_positive_predictive_value_mean <- mean(adaboost_validation_positive_predictive_value)
  adaboost_validation_negative_predictive_value[i] <- adaboost_validation_table[1, 1]/ sum(adaboost_validation_table[1, 1] + adaboost_validation_table[1, 2])
  adaboost_validation_negative_predictive_value_mean <- mean(adaboost_validation_negative_predictive_value)

  adaboost_holdout_true_positive_rate[i] <- (adaboost_test_true_positive_rate[i] + adaboost_validation_true_positive_rate[i])/2
  adaboost_holdout_true_positive_rate_mean <- mean(adaboost_holdout_true_positive_rate)
  adaboost_holdout_true_negative_rate[i] <- (adaboost_test_true_negative_rate[i] + adaboost_validation_true_negative_rate[i])/2
  adaboost_holdout_true_negative_rate_mean <- mean(adaboost_holdout_true_negative_rate)
  adaboost_holdout_false_positive_rate[i] <- (adaboost_test_false_positive_rate[i] + adaboost_validation_false_positive_rate[i])/2
  adaboost_holdout_false_positive_rate_mean <- mean(adaboost_holdout_false_positive_rate)
  adaboost_holdout_false_negative_rate[i] <- (adaboost_test_false_negative_rate[i] + adaboost_validation_false_negative_rate[i])/2
  adaboost_holdout_false_negative_rate_mean <- mean(adaboost_holdout_false_negative_rate)
  adaboost_holdout_accuracy[i] <- (adaboost_test_accuracy[i] + adaboost_validation_accuracy[i]) / 2
  adaboost_holdout_accuracy_mean <- mean(adaboost_holdout_accuracy)
  adaboost_holdout_F1_score[i] <- (adaboost_test_F1_score[i] + adaboost_validation_F1_score[i]) / 2
  adaboost_holdout_F1_score_mean <- mean(adaboost_holdout_F1_score)
  adaboost_holdout_positive_predictive_value[i] <- (adaboost_test_positive_predictive_value[i] + adaboost_validation_positive_predictive_value[i]) /2
  adaboost_holdout_positive_predictive_value_mean <- mean(adaboost_holdout_positive_predictive_value)
  adaboost_holdout_negative_predictive_value[i] <- (adaboost_test_negative_predictive_value[i] + adaboost_validation_negative_predictive_value[i]) /2
  adaboost_holdout_negative_predictive_value_mean <- mean(adaboost_holdout_negative_predictive_value)
  ...
  pls_train_fit <- MachineShop::fit(as.factor(y) ~ ., data = train01, model = "PLSModel")

  pls_train_pred <- stats::predict(pls_train_fit, train01, type = "response")
  pls_train_table <- table(pls_train_pred, y_train)
  pls_train_true_positive_rate[i] <- pls_train_table[2,2] / sum(pls_train_table[2, 2] + pls_train_table[1, 2])
  pls_train_true_positive_rate_mean <- mean(pls_train_true_positive_rate)
  pls_train_true_negative_rate[i] <- pls_train_table[1,1]/ sum(pls_train_table[1,1] + pls_train_table[2,1])
  pls_train_true_negative_rate_mean <- mean(pls_train_true_negative_rate)
  pls_train_false_positive_rate[i] <- pls_train_table[2, 1] / sum(pls_train_table[2, 1] + pls_train_table[1, 1])
  pls_train_false_positive_rate_mean <- mean(pls_train_false_positive_rate)
  pls_train_false_negative_rate[i] <- pls_train_table[1, 2] / sum(pls_train_table[1, 2] + pls_train_table[2, 2])
  pls_train_false_negative_rate_mean <- mean(pls_train_false_negative_rate)
  pls_train_accuracy[i] <- (pls_train_table[1,1] + pls_train_table[2,2]) / sum(pls_train_table)
  pls_train_accuracy_mean <- mean(pls_train_accuracy)
  pls_train_F1_score[i] <- 2*(pls_train_table[2,2]) / sum(2 * pls_train_table[2,2] + pls_train_table[1,2] + pls_train_table[2,1])
  pls_train_F1_score_mean <- mean(pls_train_F1_score)
  pls_train_positive_predictive_value[i] = pls_train_table[2, 2] / sum(pls_train_table[2, 2] + pls_train_table[2, 1])
  pls_train_positive_predictive_value_mean <- mean(pls_train_positive_predictive_value)
  pls_train_negative_predictive_value[i] <- pls_train_table[1, 1]/ sum(pls_train_table[1, 1] + pls_train_table[1, 2])
  pls_train_negative_predictive_value_mean <- mean(pls_train_negative_predictive_value)

  pls_test_pred <- stats::predict(pls_train_fit, test01, type = "response")
  pls_test_table <- table(pls_test_pred, y_test)
  pls_test_true_positive_rate[i] <- pls_test_table[2,2] / sum(pls_test_table[2, 2] + pls_test_table[1, 2])
  pls_test_true_positive_rate_mean <- mean(pls_test_true_positive_rate)
  pls_test_true_negative_rate[i] <- pls_test_table[1,1]/ sum(pls_test_table[1,1] + pls_test_table[2,1])
  pls_test_true_negative_rate_mean <- mean(pls_test_true_negative_rate)
  pls_test_false_positive_rate[i] <- pls_test_table[2, 1] / sum(pls_test_table[2, 1] + pls_test_table[1, 1])
  pls_test_false_positive_rate_mean <- mean(pls_test_false_positive_rate)
  pls_test_false_negative_rate[i] <- pls_test_table[1, 2] / sum(pls_test_table[1, 2] + pls_test_table[2, 2])
  pls_test_false_negative_rate_mean <- mean(pls_test_false_negative_rate)
  pls_test_accuracy[i] <- (pls_test_table[1,1] + pls_test_table[2,2]) / sum(pls_test_table)
  pls_test_accuracy_mean <- mean(pls_test_accuracy)
  pls_test_F1_score[i] <- 2*(pls_test_table[2,2]) / sum(2 * pls_test_table[2,2] + pls_test_table[1,2] + pls_test_table[2,1])
  pls_test_F1_score_mean <- mean(pls_test_F1_score)
  pls_test_positive_predictive_value[i] = pls_test_table[2, 2] / sum(pls_test_table[2, 2] + pls_test_table[2, 1])
  pls_test_positive_predictive_value_mean <- mean(pls_test_positive_predictive_value)
  pls_test_negative_predictive_value[i] <- pls_test_table[1, 1]/ sum(pls_test_table[1, 1] + pls_test_table[1, 2])
  pls_test_negative_predictive_value_mean <- mean(pls_test_negative_predictive_value)

  pls_validation_pred <- stats::predict(pls_train_fit, validation01, type = "response")
  pls_validation_table <- table(pls_validation_pred, y_validation)
  pls_validation_true_positive_rate[i] <- pls_validation_table[2,2] / sum(pls_validation_table[2, 2] + pls_validation_table[1, 2])
  pls_validation_true_positive_rate_mean <- mean(pls_validation_true_positive_rate)
  pls_validation_true_negative_rate[i] <- pls_validation_table[1,1]/ sum(pls_validation_table[1,1] + pls_validation_table[2,1])
  pls_validation_true_negative_rate_mean <- mean(pls_validation_true_negative_rate)
  pls_validation_false_positive_rate[i] <- pls_validation_table[2, 1] / sum(pls_validation_table[2, 1] + pls_validation_table[1, 1])
  pls_validation_false_positive_rate_mean <- mean(pls_validation_false_positive_rate)
  pls_validation_false_negative_rate[i] <- pls_validation_table[1, 2] / sum(pls_validation_table[1, 2] + pls_validation_table[2, 2])
  pls_validation_false_negative_rate_mean <- mean(pls_validation_false_negative_rate)
  pls_validation_accuracy[i] <- (pls_validation_table[1,1] + pls_validation_table[2,2]) / sum(pls_validation_table)
  pls_validation_accuracy_mean <- mean(pls_validation_accuracy)
  pls_validation_F1_score[i] <- 2*(pls_validation_table[2,2]) / sum(2 * pls_validation_table[2,2] + pls_validation_table[1,2] + pls_validation_table[2,1])
  pls_validation_F1_score_mean <- mean(pls_validation_F1_score)
  pls_validation_positive_predictive_value[i] = pls_validation_table[2, 2] / sum(pls_validation_table[2, 2] + pls_validation_table[2, 1])
  pls_validation_positive_predictive_value_mean <- mean(pls_validation_positive_predictive_value)
  pls_validation_negative_predictive_value[i] <- pls_validation_table[1, 1]/ sum(pls_validation_table[1, 1] + pls_validation_table[1, 2])
  pls_validation_negative_predictive_value_mean <- mean(pls_validation_negative_predictive_value)

  pls_holdout_true_positive_rate[i] <- (pls_test_true_positive_rate[i] + pls_validation_true_positive_rate[i])/2
  pls_holdout_true_positive_rate_mean <- mean(pls_holdout_true_positive_rate)
  pls_holdout_true_negative_rate[i] <- (pls_test_true_negative_rate[i] + pls_validation_true_negative_rate[i])/2
  pls_holdout_true_negative_rate_mean <- mean(pls_holdout_true_negative_rate)
  pls_holdout_false_positive_rate[i] <- (pls_test_false_positive_rate[i] + pls_validation_false_positive_rate[i])/2
  pls_holdout_false_positive_rate_mean <- mean(pls_holdout_false_positive_rate)
  pls_holdout_false_negative_rate[i] <- (pls_test_false_negative_rate[i] + pls_validation_false_negative_rate[i])/2
  pls_holdout_false_negative_rate_mean <- mean(pls_holdout_false_negative_rate)
  pls_holdout_accuracy[i] <- (pls_test_accuracy[i] + pls_validation_accuracy[i]) / 2
  pls_holdout_accuracy_mean <- mean(pls_holdout_accuracy)
  pls_holdout_F1_score[i] <- (pls_test_F1_score[i] + pls_validation_F1_score[i]) / 2
  pls_holdout_F1_score_mean <- mean(pls_holdout_F1_score)
  pls_holdout_positive_predictive_value[i] <- (pls_test_positive_predictive_value[i] + pls_validation_positive_predictive_value[i]) /2
  pls_holdout_positive_predictive_value_mean <- mean(pls_holdout_positive_predictive_value)
  pls_holdout_negative_predictive_value[i] <- (pls_test_negative_predictive_value[i] + pls_validation_negative_predictive_value[i]) /2
  pls_holdout_negative_predictive_value_mean <- mean(pls_holdout_negative_predictive_value)
  ...
  rda_train_fit <- klaR::rda(as.factor(y_train) ~ ., data = train)

  rda_train_pred <- stats::predict(rda_train_fit, train01, type = "prob")
  rda_train_probabilities <- ifelse(rda_train_pred$posterior[, 2] > 0.5, 1, 0)
  rda_train_table <- table(rda_train_probabilities, y_train)
  rda_train_true_positive_rate[i] <- rda_train_table[2,2] / sum(rda_train_table[2, 2] + rda_train_table[1, 2])
  rda_train_true_positive_rate_mean <- mean(rda_train_true_positive_rate)
  rda_train_true_negative_rate[i] <- rda_train_table[1,1]/ sum(rda_train_table[1,1] + rda_train_table[2,1])
  rda_train_true_negative_rate_mean <- mean(rda_train_true_negative_rate)
  rda_train_false_positive_rate[i] <- rda_train_table[2, 1] / sum(rda_train_table[2, 1] + rda_train_table[1, 1])
  rda_train_false_positive_rate_mean <- mean(rda_train_false_positive_rate)
  rda_train_false_negative_rate[i] <- rda_train_table[1, 2] / sum(rda_train_table[1, 2] + rda_train_table[2, 2])
  rda_train_false_negative_rate_mean <- mean(rda_train_false_negative_rate)
  rda_train_accuracy[i] <- (rda_train_table[1,1] + rda_train_table[2,2]) / sum(rda_train_table)
  rda_train_accuracy_mean <- mean(rda_train_accuracy)
  rda_train_F1_score[i] <- 2*(rda_train_table[2,2]) / sum(2 * rda_train_table[2,2] + rda_train_table[1,2] + rda_train_table[2,1])
  rda_train_F1_score_mean <- mean(rda_train_F1_score)
  rda_train_positive_predictive_value[i] = rda_train_table[2, 2] / sum(rda_train_table[2, 2] + rda_train_table[2, 1])
  rda_train_positive_predictive_value_mean <- mean(rda_train_positive_predictive_value)
  rda_train_negative_predictive_value[i] <- rda_train_table[1, 1]/ sum(rda_train_table[1, 1] + rda_train_table[1, 2])
  rda_train_negative_predictive_value_mean <- mean(rda_train_negative_predictive_value)

  rda_test_pred <- stats::predict(rda_train_fit, test01, type = "prob")
  rda_test_probabilities <- ifelse(rda_test_pred$posterior[, 2] > 0.5, 1, 0)
  rda_test_table <- table(rda_test_pred$class, y_test)
  rda_test_true_positive_rate[i] <- rda_test_table[2,2] / sum(rda_test_table[2, 2] + rda_test_table[1, 2])
  rda_test_true_positive_rate_mean <- mean(rda_test_true_positive_rate)
  rda_test_true_negative_rate[i] <- rda_test_table[1,1]/ sum(rda_test_table[1,1] + rda_test_table[2,1])
  rda_test_true_negative_rate_mean <- mean(rda_test_true_negative_rate)
  rda_test_false_positive_rate[i] <- rda_test_table[2, 1] / sum(rda_test_table[2, 1] + rda_test_table[1, 1])
  rda_test_false_positive_rate_mean <- mean(rda_test_false_positive_rate)
  rda_test_false_negative_rate[i] <- rda_test_table[1, 2] / sum(rda_test_table[1, 2] + rda_test_table[2, 2])
  rda_test_false_negative_rate_mean <- mean(rda_test_false_negative_rate)
  rda_test_accuracy[i] <- (rda_test_table[1,1] + rda_test_table[2,2]) / sum(rda_test_table)
  rda_test_accuracy_mean <- mean(rda_test_accuracy)
  rda_test_F1_score[i] <- 2*(rda_test_table[2,2]) / sum(2 * rda_test_table[2,2] + rda_test_table[1,2] + rda_test_table[2,1])
  rda_test_F1_score_mean <- mean(rda_test_F1_score)
  rda_test_positive_predictive_value[i] = rda_test_table[2, 2] / sum(rda_test_table[2, 2] + rda_test_table[2, 1])
  rda_test_positive_predictive_value_mean <- mean(rda_test_positive_predictive_value)
  rda_test_negative_predictive_value[i] <- rda_test_table[1, 1]/ sum(rda_test_table[1, 1] + rda_test_table[1, 2])
  rda_test_negative_predictive_value_mean <- mean(rda_test_negative_predictive_value)

  rda_validation_pred <- stats::predict(rda_train_fit, validation01, type = "prob")
  rda_validation_probabilities <- ifelse(rda_validation_pred$posterior[, 2] > 0.5, 1, 0)
  rda_validation_table <- table(rda_validation_pred$class, y_validation)
  rda_validation_true_positive_rate[i] <- rda_validation_table[2,2] / sum(rda_validation_table[2, 2] + rda_validation_table[1, 2])
  rda_validation_true_positive_rate_mean <- mean(rda_validation_true_positive_rate)
  rda_validation_true_negative_rate[i] <- rda_validation_table[1,1]/ sum(rda_validation_table[1,1] + rda_validation_table[2,1])
  rda_validation_true_negative_rate_mean <- mean(rda_validation_true_negative_rate)
  rda_validation_false_positive_rate[i] <- rda_validation_table[2, 1] / sum(rda_validation_table[2, 1] + rda_validation_table[1, 1])
  rda_validation_false_positive_rate_mean <- mean(rda_validation_false_positive_rate)
  rda_validation_false_negative_rate[i] <- rda_validation_table[1, 2] / sum(rda_validation_table[1, 2] + rda_validation_table[2, 2])
  rda_validation_false_negative_rate_mean <- mean(rda_validation_false_negative_rate)
  rda_validation_accuracy[i] <- (rda_validation_table[1,1] + rda_validation_table[2,2]) / sum(rda_validation_table)
  rda_validation_accuracy_mean <- mean(rda_validation_accuracy)
  rda_validation_F1_score[i] <- 2*(rda_validation_table[2,2]) / sum(2 * rda_validation_table[2,2] + rda_validation_table[1,2] + rda_validation_table[2,1])
  rda_validation_F1_score_mean <- mean(rda_validation_F1_score)
  rda_validation_positive_predictive_value[i] = rda_validation_table[2, 2] / sum(rda_validation_table[2, 2] + rda_validation_table[2, 1])
  rda_validation_positive_predictive_value_mean <- mean(rda_validation_positive_predictive_value)
  rda_validation_negative_predictive_value[i] <- rda_validation_table[1, 1]/ sum(rda_validation_table[1, 1] + rda_validation_table[1, 2])
  rda_validation_negative_predictive_value_mean <- mean(rda_validation_negative_predictive_value)

  rda_holdout_true_positive_rate[i] <- (rda_test_true_positive_rate[i] + rda_validation_true_positive_rate[i])/2
  rda_holdout_true_positive_rate_mean <- mean(rda_holdout_true_positive_rate)
  rda_holdout_true_negative_rate[i] <- (rda_test_true_negative_rate[i] + rda_validation_true_negative_rate[i])/2
  rda_holdout_true_negative_rate_mean <- mean(rda_holdout_true_negative_rate)
  rda_holdout_false_positive_rate[i] <- (rda_test_false_positive_rate[i] + rda_validation_false_positive_rate[i])/2
  rda_holdout_false_positive_rate_mean <- mean(rda_holdout_false_positive_rate)
  rda_holdout_false_negative_rate[i] <- (rda_test_false_negative_rate[i] + rda_validation_false_negative_rate[i])/2
  rda_holdout_false_negative_rate_mean <- mean(rda_holdout_false_negative_rate)
  rda_holdout_accuracy[i] <- (rda_test_accuracy[i] + rda_validation_accuracy[i]) / 2
  rda_holdout_accuracy_mean <- mean(rda_holdout_accuracy)
  rda_holdout_F1_score[i] <- (rda_test_F1_score[i] + rda_validation_F1_score[i]) / 2
  rda_holdout_F1_score_mean <- mean(rda_holdout_F1_score)
  rda_holdout_positive_predictive_value[i] <- (rda_test_positive_predictive_value[i] + rda_validation_positive_predictive_value[i]) /2
  rda_holdout_positive_predictive_value_mean <- mean(rda_holdout_positive_predictive_value)
  rda_holdout_negative_predictive_value[i] <- (rda_test_negative_predictive_value[i] + rda_validation_negative_predictive_value[i]) /2
  rda_holdout_negative_predictive_value_mean <- mean(rda_holdout_negative_predictive_value)
  ...
  ensemble1 <- data.frame('ADA_boost' = c(adaboost_test_pred, adaboost_validation_pred),
                          ...
                          'Partial_Least_Squares' = as.numeric(c(pls_test_pred, pls_validation_pred)) -1,
                          ...
                          'Regularized_Discriminant_Analysis' = as.numeric(c(rda_test_pred$class, rda_validation_pred$class)) -1,
  ...
  ensemble_correlation <- cor(ensemble1)
  ...
  ensemble_adaboost_train_true_positive_rate[i] <- ensemble_adaboost_train_table[2,2] / sum(ensemble_adaboost_train_table[2, 2] + ensemble_adaboost_train_table[1, 2])
  ensemble_adaboost_train_true_positive_rate_mean <- mean(ensemble_adaboost_train_true_positive_rate)
  ensemble_adaboost_train_true_negative_rate[i] <- ensemble_adaboost_train_table[1,1]/ sum(ensemble_adaboost_train_table[1,1] + ensemble_adaboost_train_table[2,1])
  ensemble_adaboost_train_true_negative_rate_mean <- mean(ensemble_adaboost_train_true_negative_rate)
  ensemble_adaboost_train_false_positive_rate[i] <- ensemble_adaboost_train_table[2, 1] / sum(ensemble_adaboost_train_table[2, 1] + ensemble_adaboost_train_table[1, 1])
  ensemble_adaboost_train_false_positive_rate_mean <- mean(ensemble_adaboost_train_false_positive_rate)
  ensemble_adaboost_train_false_negative_rate[i] <- ensemble_adaboost_train_table[1, 2] / sum(ensemble_adaboost_train_table[1, 2] + ensemble_adaboost_train_table[2, 2])
  ensemble_adaboost_train_false_negative_rate_mean <- mean(ensemble_adaboost_train_false_negative_rate)
  ...
  ensemble_adaboost_train_F1_score[i] <- 2*(ensemble_adaboost_train_table[2,2]) / sum(2 * ensemble_adaboost_train_table[2,2] + ensemble_adaboost_train_table[1,2] + ensemble_adaboost_train_table[2,1])
  ensemble_adaboost_train_F1_score_mean <- mean(ensemble_adaboost_train_F1_score)
  ensemble_adaboost_train_positive_predictive_value[i] = ensemble_adaboost_train_table[2, 2] / sum(ensemble_adaboost_train_table[2, 2] + ensemble_adaboost_train_table[2, 1])
  ensemble_adaboost_train_positive_predictive_value_mean <- mean(ensemble_adaboost_train_positive_predictive_value)
  ensemble_adaboost_train_negative_predictive_value[i] <- ensemble_adaboost_train_table[1, 1]/ sum(ensemble_adaboost_train_table[1, 1] + ensemble_adaboost_train_table[1, 2])
  ensemble_adaboost_train_negative_predictive_value_mean <- mean(ensemble_adaboost_train_negative_predictive_value)
  ...
  ensemble_adaboost_test_true_positive_rate[i] <- ensemble_adaboost_test_table[2,2] / sum(ensemble_adaboost_test_table[2, 2] + ensemble_adaboost_test_table[1, 2])
  ensemble_adaboost_test_true_positive_rate_mean <- mean(ensemble_adaboost_test_true_positive_rate)
  ensemble_adaboost_test_true_negative_rate[i] <- ensemble_adaboost_test_table[1,1]/ sum(ensemble_adaboost_test_table[1,1] + ensemble_adaboost_test_table[2,1])
  ensemble_adaboost_test_true_negative_rate_mean <- mean(ensemble_adaboost_test_true_negative_rate)
  ensemble_adaboost_test_false_positive_rate[i] <- ensemble_adaboost_test_table[2, 1] / sum(ensemble_adaboost_test_table[2, 1] + ensemble_adaboost_test_table[1, 1])
  ensemble_adaboost_test_false_positive_rate_mean <- mean(ensemble_adaboost_test_false_positive_rate)
  ensemble_adaboost_test_false_negative_rate[i] <- ensemble_adaboost_test_table[1, 2] / sum(ensemble_adaboost_test_table[1, 2] + ensemble_adaboost_test_table[2, 2])
  ensemble_adaboost_test_false_negative_rate_mean <- mean(ensemble_adaboost_test_false_negative_rate)
  ...
  ensemble_adaboost_test_F1_score[i] <- 2*(ensemble_adaboost_test_table[2,2]) / sum(2 * ensemble_adaboost_test_table[2,2] + ensemble_adaboost_test_table[1,2] + ensemble_adaboost_test_table[2,1])
  ensemble_adaboost_test_F1_score_mean <- mean(ensemble_adaboost_test_F1_score)
  ensemble_adaboost_test_positive_predictive_value[i] = ensemble_adaboost_test_table[2, 2] / sum(ensemble_adaboost_test_table[2, 2] + ensemble_adaboost_test_table[2, 1])
  ensemble_adaboost_test_positive_predictive_value_mean <- mean(ensemble_adaboost_test_positive_predictive_value)
  ensemble_adaboost_test_negative_predictive_value[i] <- ensemble_adaboost_test_table[1, 1]/ sum(ensemble_adaboost_test_table[1, 1] + ensemble_adaboost_test_table[1, 2])
  ensemble_adaboost_test_negative_predictive_value_mean <- mean(ensemble_adaboost_test_negative_predictive_value)

  ensemble_adaboost_validation_pred <- stats::predict(ensemble_adaboost_train_fit, ensemble_validation, type = "prob")
  ensemble_adaboost_validation_probabilities <- ifelse(ensemble_adaboost_validation_pred > 0.5, 1, 0)
  ensemble_adaboost_validation_table <- table(ensemble_adaboost_validation_probabilities, ensemble_y_validation)
  ensemble_adaboost_validation_true_positive_rate[i] <- ensemble_adaboost_validation_table[2,2] / sum(ensemble_adaboost_validation_table[2, 2] + ensemble_adaboost_validation_table[1, 2])
  ensemble_adaboost_validation_true_positive_rate_mean <- mean(ensemble_adaboost_validation_true_positive_rate)
  ensemble_adaboost_validation_true_negative_rate[i] <- ensemble_adaboost_validation_table[1,1]/ sum(ensemble_adaboost_validation_table[1,1] + ensemble_adaboost_validation_table[2,1])
  ensemble_adaboost_validation_true_negative_rate_mean <- mean(ensemble_adaboost_validation_true_negative_rate)
  ensemble_adaboost_validation_false_positive_rate[i] <- ensemble_adaboost_validation_table[2, 1] / sum(ensemble_adaboost_validation_table[2, 1] + ensemble_adaboost_validation_table[1, 1])
  ensemble_adaboost_validation_false_positive_rate_mean <- mean(ensemble_adaboost_validation_false_positive_rate)
  ensemble_adaboost_validation_false_negative_rate[i] <- ensemble_adaboost_validation_table[1, 2] / sum(ensemble_adaboost_validation_table[1, 2] + ensemble_adaboost_validation_table[2, 2])
  ensemble_adaboost_validation_false_negative_rate_mean <- mean(ensemble_adaboost_validation_false_negative_rate)
  ensemble_adaboost_validation_accuracy[i] <- (ensemble_adaboost_validation_table[1,1] + ensemble_adaboost_validation_table[2,2]) / sum(ensemble_adaboost_validation_table)
  ensemble_adaboost_validation_accuracy_mean <- mean(ensemble_adaboost_validation_accuracy)
  ensemble_adaboost_validation_F1_score[i] <- 2*(ensemble_adaboost_validation_table[2,2]) / sum(2 * ensemble_adaboost_validation_table[2,2] + ensemble_adaboost_validation_table[1,2] + ensemble_adaboost_validation_table[2,1])
  ensemble_adaboost_validation_F1_score_mean <- mean(ensemble_adaboost_validation_F1_score)
  ensemble_adaboost_validation_positive_predictive_value[i] = ensemble_adaboost_validation_table[2, 2] / sum(ensemble_adaboost_validation_table[2, 2] + ensemble_adaboost_validation_table[2, 1])
  ensemble_adaboost_validation_positive_predictive_value_mean <- mean(ensemble_adaboost_validation_positive_predictive_value)
  ensemble_adaboost_validation_negative_predictive_value[i] <- ensemble_adaboost_validation_table[1, 1]/ sum(ensemble_adaboost_validation_table[1, 1] + ensemble_adaboost_validation_table[1, 2])
  ensemble_adaboost_validation_negative_predictive_value_mean <- mean(ensemble_adaboost_validation_negative_predictive_value)

  ensemble_adaboost_holdout_true_positive_rate[i] <- (ensemble_adaboost_test_true_positive_rate[i] + ensemble_adaboost_validation_true_positive_rate[i])/2
  ensemble_adaboost_holdout_true_positive_rate_mean <- mean(ensemble_adaboost_holdout_true_positive_rate)
  ensemble_adaboost_holdout_true_negative_rate[i] <- (ensemble_adaboost_test_true_negative_rate[i] + ensemble_adaboost_validation_true_negative_rate[i])/2
  ensemble_adaboost_holdout_true_negative_rate_mean <- mean(ensemble_adaboost_holdout_true_negative_rate)
  ensemble_adaboost_holdout_false_positive_rate[i] <- (ensemble_adaboost_test_false_positive_rate[i] + ensemble_adaboost_validation_false_positive_rate[i])/2
  ensemble_adaboost_holdout_false_positive_rate_mean <- mean(ensemble_adaboost_holdout_false_positive_rate)
  ensemble_adaboost_holdout_false_negative_rate[i] <- (ensemble_adaboost_test_false_negative_rate[i] + ensemble_adaboost_validation_false_negative_rate[i])/2
  ensemble_adaboost_holdout_false_negative_rate_mean <- mean(ensemble_adaboost_holdout_false_negative_rate)
  ensemble_adaboost_holdout_accuracy[i] <- (ensemble_adaboost_test_accuracy[i] + ensemble_adaboost_validation_accuracy[i]) / 2
  ensemble_adaboost_holdout_accuracy_mean <- mean(ensemble_adaboost_holdout_accuracy)
  ensemble_adaboost_holdout_F1_score[i] <- (ensemble_adaboost_test_F1_score[i] + ensemble_adaboost_validation_F1_score[i]) / 2
  ensemble_adaboost_holdout_F1_score_mean <- mean(ensemble_adaboost_holdout_F1_score)
  ensemble_adaboost_holdout_positive_predictive_value[i] <- (ensemble_adaboost_test_positive_predictive_value[i] + ensemble_adaboost_validation_positive_predictive_value[i]) /2
  ensemble_adaboost_holdout_positive_predictive_value_mean <- mean(ensemble_adaboost_holdout_positive_predictive_value)
  ensemble_adaboost_holdout_negative_predictive_value[i] <- (ensemble_adaboost_test_negative_predictive_value[i] + ensemble_adaboost_validation_negative_predictive_value[i]) /2
  ensemble_adaboost_holdout_negative_predictive_value_mean <- mean(ensemble_adaboost_holdout_negative_predictive_value)
...
adaboost_roc_obj <- pROC::roc(c(test01$y, validation01$y), c(adaboost_test_pred, adaboost_validation_pred))
adaboost_auc <- round(pROC::auc(c(test01$y, validation01$y), c(adaboost_test_pred, adaboost_validation_pred)), 4)
...
ensemble_adaboost_auc <- round((pROC::auc(c(ensemble_test$y, ensemble_validation$y), as.numeric(c(ensemble_adaboost_test_pred, ensemble_adaboost_validation_pred))-1)), 4)
...
ROC_curves <- gridExtra::grid.arrange(adaboost_ROC, bag_rf_ROC, bagging_ROC,
                                      bayesglm_ROC, bayesrnn_ROC, C50_ROC,
                                      cubist_ROC, fda_ROC, gam_ROC,
                                      gb_ROC, glm_ROC, linear_ROC,
                                      lda_ROC, mda_ROC, n_bayes_ROC,
                                      pls_ROC, pda_ROC, qda_ROC,
                                      rf_ROC, ranger_ROC, rda_ROC,
                                      rpart_ROC, svm_ROC, tree_ROC, xgb_ROC,
                                      ensemble_adaboost_ROC, ensemble_bagging_ROC,
                                      ensemble_C50_ROC,
                                      ensemble_gb_ROC,
                                      ensemble_pls_ROC,
                                      ensemble_pda_ROC,
                                      ...
                                      ensemble_svm_ROC,
                                      ensemble_tree_ROC, ensemble_xgb_ROC, ncol = 5)




holdout_results <- data.frame(
  Model = c('ADA Boost', 'Bagged Random Forest', 'Bagging', 'Bayes GLM', 'Bayes RNN', 'C50', 'Cubist', 'Flexible Discriminant Analysis',
            ...
            'Partial Least Squares', 'Penalized Discriminant Analysis', 'Quadratic Discriminant Analysis', 'Random Forest',
            'Ranger', 'Regularized Discriminant Analysis', 'RPart', 'Support Vector Machines', 'Trees', 'XGBoost',
            'Ensemble ADA Boost', 'Ensemble Bagging', 'Ensemble C50', 'Ensemble Gradient Boosted',
  ...
  'Accuracy' = round(c(adaboost_holdout_accuracy_mean, bag_rf_holdout_accuracy_mean, bagging_holdout_accuracy_mean, bayesglm_holdout_accuracy_mean,
                       bayesrnn_holdout_accuracy_mean, C50_holdout_accuracy_mean, cubist_holdout_accuracy_mean, fda_holdout_accuracy_mean,
                       gam_holdout_accuracy_mean, gb_holdout_accuracy_mean, glm_holdout_accuracy_mean, linear_holdout_accuracy_mean,
                       lda_holdout_accuracy_mean, mda_holdout_accuracy_mean, n_bayes_holdout_accuracy_mean, pls_holdout_accuracy_mean,
                       pda_holdout_accuracy_mean, qda_holdout_accuracy_mean, rf_holdout_accuracy_mean, ranger_holdout_accuracy_mean,
                       rda_holdout_accuracy_mean, rpart_holdout_accuracy_mean, svm_holdout_accuracy_mean, tree_holdout_accuracy_mean, xgb_holdout_accuracy_mean,
                       ensemble_adaboost_holdout_accuracy_mean, ensemble_bagging_holdout_accuracy_mean, ensemble_C50_holdout_accuracy_mean,
                       ...
                       ensemble_svm_holdout_accuracy_mean, ensemble_tree_holdout_accuracy_mean, ensemble_xgb_holdout_accuracy_mean), 4),

  'True_Positive_Rate_aka_Sensitivity' = round(c(adaboost_holdout_true_positive_rate_mean, bag_rf_holdout_true_positive_rate_mean, bagging_holdout_true_positive_rate_mean, bayesglm_holdout_true_positive_rate_mean,
                                                 bayesrnn_holdout_true_positive_rate_mean, C50_holdout_true_positive_rate_mean, cubist_holdout_true_positive_rate_mean, fda_holdout_true_positive_rate_mean,
                                                 ...
                                                 lda_holdout_true_positive_rate_mean, mda_holdout_true_positive_rate_mean, n_bayes_holdout_true_positive_rate_mean, pls_holdout_true_positive_rate_mean,
                                                 ...
                                                 rda_holdout_true_positive_rate_mean, rpart_holdout_true_positive_rate_mean, svm_holdout_true_positive_rate_mean, tree_holdout_true_positive_rate_mean, xgb_holdout_true_positive_rate_mean,
                                                 ensemble_adaboost_holdout_true_positive_rate_mean, ensemble_bagging_holdout_true_positive_rate_mean, ensemble_C50_holdout_true_positive_rate_mean,
                                                 ...
                                                 ensemble_svm_holdout_true_positive_rate_mean, ensemble_tree_holdout_true_positive_rate_mean, ensemble_xgb_holdout_true_positive_rate_mean), 4),

  'True_Negative_Rate_aka_Specificity' = round(c(adaboost_holdout_true_negative_rate_mean, bag_rf_holdout_true_negative_rate_mean, bagging_holdout_true_negative_rate_mean, bayesglm_holdout_true_negative_rate_mean,
                                                 bayesrnn_holdout_true_negative_rate_mean, C50_holdout_true_negative_rate_mean, cubist_holdout_true_negative_rate_mean, fda_holdout_true_negative_rate_mean,
                                                 ...
                                                 lda_holdout_true_negative_rate_mean, mda_holdout_true_negative_rate_mean, n_bayes_holdout_true_negative_rate_mean, pls_holdout_true_negative_rate_mean,
                                                 ...
                                                 rda_holdout_true_negative_rate_mean, rpart_holdout_true_negative_rate_mean, svm_holdout_true_negative_rate_mean, tree_holdout_true_negative_rate_mean, xgb_holdout_true_negative_rate_mean,
                                                 ensemble_adaboost_holdout_true_negative_rate_mean, ensemble_bagging_holdout_true_negative_rate_mean, ensemble_C50_holdout_true_negative_rate_mean,
                                                 ...
                                                 ensemble_svm_holdout_true_negative_rate_mean, ensemble_tree_holdout_true_negative_rate_mean, ensemble_xgb_holdout_true_negative_rate_mean), 4),

  'False_Positive_Rate_aka_Type_I_Error' = round(c(adaboost_holdout_false_positive_rate_mean, bag_rf_holdout_false_positive_rate_mean, bagging_holdout_false_positive_rate_mean, bayesglm_holdout_false_positive_rate_mean,
                                                   bayesrnn_holdout_false_positive_rate_mean, C50_holdout_false_positive_rate_mean, cubist_holdout_false_positive_rate_mean, fda_holdout_false_positive_rate_mean,
                                                   ...
                                                   lda_holdout_false_positive_rate_mean, mda_holdout_false_positive_rate_mean, n_bayes_holdout_false_positive_rate_mean, pls_holdout_false_positive_rate_mean,
                                                   ...
                                                   rda_holdout_false_positive_rate_mean, rpart_holdout_false_positive_rate_mean, svm_holdout_false_positive_rate_mean, tree_holdout_false_positive_rate_mean, xgb_holdout_false_positive_rate_mean,
                                                   ensemble_adaboost_holdout_false_positive_rate_mean, ensemble_bagging_holdout_false_positive_rate_mean, ensemble_C50_holdout_false_positive_rate_mean,
                                                   ...
                                                   ensemble_svm_holdout_false_positive_rate_mean, ensemble_tree_holdout_false_positive_rate_mean, ensemble_xgb_holdout_false_positive_rate_mean), 4),

  'False_Negative_Rate_aka_Type_II_Error' = round(c(adaboost_holdout_false_negative_rate_mean, bag_rf_holdout_false_negative_rate_mean, bagging_holdout_false_negative_rate_mean, bayesglm_holdout_false_negative_rate_mean,
                                                    bayesrnn_holdout_false_negative_rate_mean, C50_holdout_false_negative_rate_mean, cubist_holdout_false_negative_rate_mean, fda_holdout_false_negative_rate_mean,
                                                    ...
                                                    lda_holdout_false_negative_rate_mean, mda_holdout_false_negative_rate_mean, n_bayes_holdout_false_negative_rate_mean, pls_holdout_false_negative_rate_mean,
                                                    ...
                                                    rda_holdout_false_negative_rate_mean, rpart_holdout_false_negative_rate_mean, svm_holdout_false_negative_rate_mean, tree_holdout_false_negative_rate_mean, xgb_holdout_false_negative_rate_mean,
                                                    ensemble_adaboost_holdout_false_negative_rate_mean, ensemble_bagging_holdout_false_negative_rate_mean, ensemble_C50_holdout_false_negative_rate_mean,
                                                    ...
                                                    ensemble_svm_holdout_false_negative_rate_mean, ensemble_tree_holdout_false_negative_rate_mean, ensemble_xgb_holdout_false_negative_rate_mean), 4),

  'Positive_Predictive_Value_ada_Precision' = round(c(adaboost_holdout_positive_predictive_value_mean, bag_rf_holdout_positive_predictive_value_mean, bagging_holdout_positive_predictive_value_mean, bayesglm_holdout_positive_predictive_value_mean,
                                                      bayesrnn_holdout_positive_predictive_value_mean, C50_holdout_positive_predictive_value_mean, cubist_holdout_positive_predictive_value_mean, fda_holdout_positive_predictive_value_mean,
                                                      ...
                                                      lda_holdout_positive_predictive_value_mean, mda_holdout_positive_predictive_value_mean, n_bayes_holdout_positive_predictive_value_mean, pls_holdout_positive_predictive_value_mean,
                                                      ...
                                                      rda_holdout_positive_predictive_value_mean, rpart_holdout_positive_predictive_value_mean, svm_holdout_positive_predictive_value_mean, tree_holdout_positive_predictive_value_mean, xgb_holdout_positive_predictive_value_mean,
                                                      ensemble_adaboost_holdout_positive_predictive_value_mean, ensemble_bagging_holdout_positive_predictive_value_mean, ensemble_C50_holdout_positive_predictive_value_mean,
                                                      ...
                                                      ensemble_svm_holdout_positive_predictive_value_mean, ensemble_tree_holdout_positive_predictive_value_mean, ensemble_xgb_holdout_positive_predictive_value_mean), 4),

  'Negative_Predictive_Value' = round(c(adaboost_holdout_negative_predictive_value_mean, bag_rf_holdout_negative_predictive_value_mean, bagging_holdout_negative_predictive_value_mean, bayesglm_holdout_negative_predictive_value_mean,
                                        bayesrnn_holdout_negative_predictive_value_mean, C50_holdout_negative_predictive_value_mean, cubist_holdout_negative_predictive_value_mean, fda_holdout_negative_predictive_value_mean,
                                        ...
                                        lda_holdout_negative_predictive_value_mean, mda_holdout_negative_predictive_value_mean, n_bayes_holdout_negative_predictive_value_mean, pls_holdout_negative_predictive_value_mean,
                                        ...
                                        rda_holdout_negative_predictive_value_mean, rpart_holdout_negative_predictive_value_mean, svm_holdout_negative_predictive_value_mean, tree_holdout_negative_predictive_value_mean, xgb_holdout_negative_predictive_value_mean,
                                        ensemble_adaboost_holdout_negative_predictive_value_mean, ensemble_bagging_holdout_negative_predictive_value_mean, ensemble_C50_holdout_negative_predictive_value_mean,
                                        ...
                                        ensemble_svm_holdout_negative_predictive_value_mean, ensemble_tree_holdout_negative_predictive_value_mean, ensemble_xgb_holdout_negative_predictive_value_mean), 4),

  'F1_Score' = round(c(adaboost_holdout_F1_score_mean, bag_rf_holdout_F1_score_mean, bagging_holdout_F1_score_mean, bayesglm_holdout_F1_score_mean,
                       bayesrnn_holdout_F1_score_mean, C50_holdout_F1_score_mean, cubist_holdout_F1_score_mean, fda_holdout_F1_score_mean,
                       gam_holdout_F1_score_mean, gb_holdout_F1_score_mean, glm_holdout_F1_score_mean, linear_holdout_F1_score_mean,
                       lda_holdout_F1_score_mean, mda_holdout_F1_score_mean, n_bayes_holdout_F1_score_mean, pls_holdout_F1_score_mean,
                       pda_holdout_F1_score_mean, qda_holdout_F1_score_mean, rf_holdout_F1_score_mean, ranger_holdout_F1_score_mean,
                       rda_holdout_F1_score_mean, rpart_holdout_F1_score_mean, svm_holdout_F1_score_mean, tree_holdout_F1_score_mean, xgb_holdout_F1_score_mean,
                       ensemble_adaboost_holdout_F1_score_mean, ensemble_bagging_holdout_F1_score_mean, ensemble_C50_holdout_F1_score_mean,
                       ...
                       ensemble_svm_holdout_F1_score_mean, ensemble_tree_holdout_F1_score_mean, ensemble_xgb_holdout_F1_score_mean), 4),

  'Area_Under_Curve' = c(adaboost_auc, bag_rf_auc, bagging_auc, bayesglm_auc,
                         bayesrnn_auc, C50_auc, cubist_auc, fda_auc,
                         gam_auc, gb_auc, glm_auc, linear_auc,
                         lda_auc, mda_auc, n_bayes_auc, pls_auc,
                         pda_auc, qda_auc, rf_auc, ranger_auc,
                         rda_auc, rpart_auc, svm_auc, tree_auc, xgb_auc,
                         ensemble_adaboost_auc, ensemble_bagging_auc, ensemble_C50_auc,
  ...
  'Duration' =round(c(adaboost_duration_mean, bag_rf_duration_mean, bagging_duration_mean, bayesglm_duration_mean,
                      bayesrnn_duration_mean, C50_duration_mean, cubist_duration_mean, fda_duration_mean,
                      gam_duration_mean, gb_duration_mean, glm_duration_mean, linear_duration_mean,
                      lda_duration_mean, mda_duration_mean, n_bayes_duration_mean, pls_duration_mean,
                      ...
                      ensemble_adaboost_duration_mean, ensemble_bagging_duration_mean, ensemble_C50_duration_mean,
                      ...
                      ensemble_svm_duration_mean, ensemble_tree_duration_mean, ensemble_xgb_duration_mean), 4)

)

holdout_results <- holdout_results %>% dplyr::arrange(desc(Accuracy))

holdout_results <- reactable::reactable(holdout_results, searchable = TRUE, pagination = FALSE, wrap = TRUE, rownames = TRUE, fullWidth = TRUE, filterable = TRUE, bordered = TRUE,
...
accuracy_data <- data.frame(
  ...
  'model' = c(rep('ADA Boost', numresamples), rep('Bagged Random Forest', numresamples), rep('Bagging', numresamples),
              rep('BayesGLM', numresamples), rep('BayesRNN', numresamples), rep('C50', numresamples),
              ...
              rep('Partial Least Squares', numresamples),rep('Penalized Discrmininant Analysis', numresamples), rep('Quadratic Discrmininant Analysis', numresamples),
              rep('Random Forest', numresamples), rep('Ranger', numresamples), rep('Regularized Discrmininant Analysis', numresamples),
              rep('RPart', numresamples), rep('Support Vector Machines', numresamples),
              rep('Trees', numresamples), rep('XGBoost', numresamples),
              rep('Ensemble ADA Boost', numresamples), rep('Ensemble Bagging', numresamples),
  ...
  'data' = c(adaboost_holdout_accuracy, bag_rf_holdout_accuracy, bagging_holdout_accuracy,
             bayesglm_holdout_accuracy, bayesrnn_holdout_accuracy, C50_holdout_accuracy,
             ...
             n_bayes_holdout_accuracy, pls_holdout_accuracy, pda_holdout_accuracy,
             qda_holdout_accuracy, rf_holdout_accuracy, ranger_holdout_accuracy,
             rda_holdout_accuracy, rpart_holdout_accuracy, svm_holdout_accuracy,
             tree_holdout_accuracy, svm_holdout_accuracy,
             ensemble_adaboost_holdout_accuracy, ensemble_bagging_holdout_accuracy,
  ...
  'mean' = rep(c(adaboost_holdout_accuracy_mean, bag_rf_holdout_accuracy_mean, bagging_holdout_accuracy_mean,
                 bayesglm_holdout_accuracy_mean, bayesrnn_holdout_accuracy_mean, C50_holdout_accuracy_mean,
                 ...
                 n_bayes_holdout_accuracy_mean, pls_holdout_accuracy_mean, pda_holdout_accuracy_mean,
                 qda_holdout_accuracy_mean, rf_holdout_accuracy_mean, ranger_holdout_accuracy_mean,
                 rda_holdout_accuracy_mean, rpart_holdout_accuracy_mean, svm_holdout_accuracy_mean,
                 tree_holdout_accuracy_mean, svm_holdout_accuracy_mean,
                 ensemble_adaboost_holdout_accuracy_mean, ensemble_bagging_holdout_accuracy_mean,
                 ...
                 ensemble_tree_holdout_accuracy_mean, ensemble_xgb_holdout_accuracy_mean), each = numresamples)
)
...
total_accuracy_data <- data.frame(
  ...
  'model' = c(rep('ADA Boost', numresamples), rep('Bagged Random Forest', numresamples), rep('Bagging', numresamples),
              ...
              rep('Naive Bayes', numresamples),  rep('Partial Least Squares', numresamples),rep('Penalized Discrmininant Analysis', numresamples),
              rep('Quadratic Discrmininant Analysis', numresamples), rep('Random Forest', numresamples), rep('Ranger', numresamples),
              rep('Regularized Discrmininant Analysis', numresamples), rep('RPart', numresamples), rep('Support Vector Machines', numresamples),
              rep('Trees', numresamples), rep('XGBoost', numresamples),
              rep('Ensemble ADA Boost', numresamples), rep('Ensemble Bagging', numresamples),
              rep('Ensemble C50', numresamples), rep('Ensemble Gradient Boosted', numresamples),
              rep('Ensemble Partial Least Squares', numresamples),
  ...
  'train' = c(adaboost_train_accuracy, bag_rf_train_accuracy, bagging_train_accuracy,
              bayesglm_train_accuracy, bayesrnn_train_accuracy, C50_train_accuracy,
              ...
              n_bayes_train_accuracy, pls_train_accuracy, pda_train_accuracy,
              qda_train_accuracy, rf_train_accuracy, ranger_train_accuracy,
              rda_train_accuracy, rpart_train_accuracy, svm_train_accuracy,
              tree_train_accuracy, svm_train_accuracy,
              ensemble_adaboost_train_accuracy, ensemble_bagging_train_accuracy,
  ...
  'test' = c(adaboost_test_accuracy, bag_rf_test_accuracy, bagging_test_accuracy,
             bayesglm_test_accuracy, bayesrnn_test_accuracy, C50_test_accuracy,
             cubist_test_accuracy, fda_test_accuracy, gam_test_accuracy,
             glm_test_accuracy, gb_test_accuracy,
             linear_test_accuracy, lda_test_accuracy, mda_test_accuracy,
             n_bayes_test_accuracy, pls_test_accuracy, pda_test_accuracy,
             qda_test_accuracy, rf_test_accuracy, ranger_test_accuracy,
             rda_test_accuracy, rpart_test_accuracy, svm_test_accuracy,
             tree_test_accuracy, svm_test_accuracy,
             ensemble_adaboost_test_accuracy, ensemble_bagging_test_accuracy,
             ensemble_C50_test_accuracy, ensemble_gb_test_accuracy,
             ensemble_pls_test_accuracy,
             ensemble_pda_test_accuracy, ensemble_rf_test_accuracy,
             ensemble_ranger_test_accuracy, ensemble_rda_test_accuracy,
             ensemble_rpart_test_accuracy, ensemble_svm_test_accuracy,
             ensemble_tree_test_accuracy, ensemble_xgb_test_accuracy),

  'validation' = c(adaboost_validation_accuracy, bag_rf_validation_accuracy, bagging_validation_accuracy,
                   bayesglm_validation_accuracy, bayesrnn_validation_accuracy, C50_validation_accuracy,
                   cubist_validation_accuracy, fda_validation_accuracy, gam_validation_accuracy,
                   glm_validation_accuracy, gb_validation_accuracy,
                   linear_validation_accuracy, lda_validation_accuracy, mda_validation_accuracy,
                   n_bayes_validation_accuracy, pls_validation_accuracy, pda_validation_accuracy,
                   qda_validation_accuracy, rf_validation_accuracy, ranger_validation_accuracy,
                   rda_validation_accuracy, rpart_validation_accuracy, svm_validation_accuracy,
                   tree_validation_accuracy, svm_validation_accuracy,
                   ensemble_adaboost_validation_accuracy, ensemble_bagging_validation_accuracy,
                   ensemble_C50_validation_accuracy, ensemble_gb_validation_accuracy,
                   ensemble_pls_validation_accuracy,
                   ensemble_pda_validation_accuracy, ensemble_rf_validation_accuracy,
                   ensemble_ranger_validation_accuracy, ensemble_rda_validation_accuracy,
                   ensemble_rpart_validation_accuracy, ensemble_svm_validation_accuracy,
                   ensemble_tree_validation_accuracy, ensemble_xgb_validation_accuracy),

  'accuracy' = c(adaboost_holdout_accuracy, bag_rf_holdout_accuracy, bagging_holdout_accuracy,
                 bayesglm_holdout_accuracy, bayesrnn_holdout_accuracy, C50_holdout_accuracy,
                 cubist_holdout_accuracy, fda_holdout_accuracy, gam_holdout_accuracy,
                 glm_holdout_accuracy, gb_holdout_accuracy,
                 linear_holdout_accuracy, lda_holdout_accuracy, mda_holdout_accuracy,
...
total_plot <- ggplot2::ggplot(data = total_accuracy_data, mapping = ggplot2::aes(x = count, y = data, color = model)) +
  ...
  ggplot2::geom_line(mapping = aes(x = count, y = accuracy, color = 'accuracy')) +
  ggplot2::geom_point(mapping = aes(x = count, y = accuracy)) +
  ggplot2::geom_hline(aes(yintercept = mean, color = 'mean')) +
  ggplot2::geom_hline(aes(yintercept = 1, color = 'optimal')) +
  ggplot2::facet_wrap(~model, ncol = 5) +
  ...
  ggplot2::scale_color_manual(name='Total Results',
                              ...
                              values=c('train' = 'blueviolet', 'test' = 'darkcyan', 'validation' = 'darkgray', 'accuracy' = 'turquoise1', 'mean' = 'black',
                                       'optimal' = 'red'))
...
if(save_all_trained_models == "Y"){
  ...
  bayesrnn_train_fit <<- bayesrnn_train_fit
...
if(do_you_have_new_data == "Y"){
  ...
  ADA_boost <- as.numeric(predict(object = adaboost_train_fit, newdata = newdata)) - 1
  ...
  BayesRNN <- as.numeric(predict(object = bayesrnn_train_fit, newdata = newdata))
  ...
  Partial_Least_Squares <- as.numeric(predict(object = pls_train_fit, newdata = newdata)) -1
  ...
  Regularized_Discriminant_Analysis <- as.numeric(predict(object = rda_train_fit, newdata = newdata)$class) -1
  ...
  new_ensemble %>% select(all_of(thing))
  ...
  summary_tables <- list('ADA_Boost' = adaboost_table, 'Bagged_Random_Forest' = bag_rf_table, 'Bagging' = bagging_table, 'BayesGLM' = bayesglm_table, 'BayesRNN' = bayesrnn_table,
                         'C50' = C50_table, 'Cubist' = cubist_table, 'Fixture Discrmininant Analysis' = fda_table, 'Generalized Additive Methods' = gam_table,
                         'Gradient Boosted' = gb_table, 'Generalized Linear Models' = glm_table, 'Linear' = linear_table, 'Linear Discrmininant Analysis' = lda_table,
                         'Mixture Discrminint Analysis' = mda_table, 'Naive Bayes' = n_bayes_table, 'Partial Least Squares' = pls_table, 'Penalized Discrminant Analysis' = pda_table,
                         'Quadratic Discrmininant Analysis' = qda_table, 'Random Forest' = rf_table, 'Ranger' = ranger_table,
                         'Regularized Discrmininant Analysis' = rda_table, 'RPart' = rpart_table, 'Support Vector Machines' = svm_table, 'Trees' = tree_table, 'XGBoost' = xgb_table,
                         'Ensembel ADABoost' = ensemble_adaboost_table, 'Ensemble Bagging' = ensemble_bagging_table, 'Ensemble C50' = ensemble_C50_table,
                         'Ensemble Gradient Boosted' = ensemble_gb_table, 'Ensemble Partial Least Squares' = ensemble_pls_table,
                         'Ensemble Penalized Discrmininant Analysis' = ensemble_pda_table, 'Ensemble Random Forest' = ensemble_rf_table,
                         'Ensemble Ranger' = ensemble_ranger_table, 'Ensemble Regularized Discrmininant Analysis' = ensemble_rda_table,
                         'Ensemble RPart' = ensemble_rpart_table, 'Ensemble Support Vector Machines' = ensemble_svm_table,
                         'Ensemble Trees' = ensemble_tree_table, 'Ensemble XGBoost' = ensemble_xgb_table)

  return(list('Summary_tables' = summary_tables, 'accuracy_plot' = accuracy_plot, 'total_plot' = total_plot, 'ROC_curves' = ROC_curves,
